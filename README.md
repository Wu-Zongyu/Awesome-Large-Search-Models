...
|---------|-----------------------------------------------------------------------------------------------------|-------|--------------------------------------------------------------------------------------------------------------|------------------------------------------------------------|
| 2025.06 | **MMSearch-R1: Incentivizing LMMs to Search**         | arXiv | [Link]( https://arxiv.org/abs/2506.20670) | [Link](https://github.com/EvolvingLMMs-Lab/multimodal-search-r1) 
